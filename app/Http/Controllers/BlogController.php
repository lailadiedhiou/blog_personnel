...
class BlogController extends Controller
{
    ...
    public function update($id, Request $request) {
     ...
     public function getFriendsBlogs() {
    ...
    $friends = $user->friends()->pluck('id'); // Get friends' IDs

    if ($friends->isEmpty()) {
        return response()->json(['message' => 'No friends found'], 404);
    }

    $blogs = Blog::whereIn('user_id', $friends)->with('user', 'comments')->get(); // Eager load related models
